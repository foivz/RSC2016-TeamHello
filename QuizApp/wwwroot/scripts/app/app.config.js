...
AppConfig.$inject = ['$urlRouterProvider', '$stateProvider', 'socialProvider', 'loginService'];

function AppConfig($urlRouterProvider, $stateProvider, socialProvider, loginService) {
